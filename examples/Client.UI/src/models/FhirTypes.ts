...
export type AidboxReference<T extends Resource = any> = Omit<
  Reference<T>,
  'id'
> & { id: keyword };
...
export interface AdverseEvent {
  ...
  contributor?: Array<
    AidboxReference<Practitioner | PractitionerRole | Device>
  >;
...
export interface BundleEntryResponse {
  /** The ResponseWithMeta for the resource (if relevant) */
  etag?: string;
  /** Additional content defined by implementations */
  extension?: Extension[];
  /** Unique id for inter-element referencing */
...
export interface Claim {
  ...
  originalPrescription?: AidboxReference<
...
export interface ClaimResponseAddItem {
  ...
  provider?: Array<
    AidboxReference<Practitioner | PractitionerRole | Organization>
  >;
  /** Count of products or services */
  quantity?: Quantity;
  /** Date or dates of service or product delivery */
...
export interface ConditionStage {
  ...
  assessment?: Array<
    AidboxReference<ClinicalImpression | DiagnosticReport | Observation>
  >;
  /** Additional content defined by implementations */
  extension?: Extension[];
  /** Unique id for inter-element referencing */
...
export interface EnrollmentResponse {
  ...
  /** Responsible practitioner */
  requestProvider?: AidboxReference<
    Practitioner | PractitionerRole | Organization
  >;
  /** active | cancelled | draft | entered-in-error */
  status?: code;
...
export interface Group {
  ...
  managingEntity?: AidboxReference<
...
export interface Immunization {
  ...
  /** Why immunization occurred */
  reasonReference?: Array<
    AidboxReference<Condition | Observation | DiagnosticReport>
  >;
...
export interface ImmunizationRecommendationRecommendation {
  ...
  supportingImmunization?: Array<
    AidboxReference<Immunization | ImmunizationEvaluation>
  >;
...
export interface MedicationStatement {
  ...
  basedOn?: Array<
    AidboxReference<MedicationRequest | CarePlan | ServiceRequest>
  >;
  /** Type of medication usage */
  category?: CodeableConcept;
  /** Contained, inline Resources */
...
export interface MedicinalProduct {
  ...
  pharmaceuticalProduct?: Array<
    AidboxReference<MedicinalProductPharmaceutical>
  >;
...
export interface Observation {
  ...
  hasMember?: Array<
    AidboxReference<Observation | QuestionnaireResponse | MolecularSequence>
  >;
...
export interface Patient {
  ...
  generalPractitioner?: Array<
    AidboxReference<Organization | Practitioner | PractitionerRole>
  >;
...
export interface Procedure {
  ...
  /** Part of referenced event */
  partOf?: Array<
    AidboxReference<Procedure | Observation | MedicationAdministration>
  >;
  /** When the procedure was performed */
  ...
  report?: Array<
    AidboxReference<DiagnosticReport | DocumentReference | Composition>
  >;
  /** preparation | in-progress | not-done | suspended | aborted | completed | entered-in-error | unknown */
  status: code;
  /** Reason for current status */
...
export interface ServiceRequest {
  ...
  /** What request fulfills */
  basedOn?: Array<
    AidboxReference<CarePlan | ServiceRequest | MedicationRequest>
  >;
  /** Location on Body */
  bodySite?: CodeableConcept[];
...
export interface AidboxConfigLicense {
  [k: string]: unknown;
}
/* tslint:disable */
/**
